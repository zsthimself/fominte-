...
export declare namespace apphub_v1 {
    ...
    export class Resource$Projects$Locations$Extendedmetadataschemas {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Extendedmetadataschemas$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Extendedmetadataschemas$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ExtendedMetadataSchema>>;
        get(params: Params$Resource$Projects$Locations$Extendedmetadataschemas$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Extendedmetadataschemas$Get, options: MethodOptions | BodyResponseCallback<Schema$ExtendedMetadataSchema>, callback: BodyResponseCallback<Schema$ExtendedMetadataSchema>): void;
        get(params: Params$Resource$Projects$Locations$Extendedmetadataschemas$Get, callback: BodyResponseCallback<Schema$ExtendedMetadataSchema>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Extendedmetadataschemas$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Extendedmetadataschemas$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListExtendedMetadataSchemasResponse>>;
        list(params: Params$Resource$Projects$Locations$Extendedmetadataschemas$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Extendedmetadataschemas$List, options: MethodOptions | BodyResponseCallback<Schema$ListExtendedMetadataSchemasResponse>, callback: BodyResponseCallback<Schema$ListExtendedMetadataSchemasResponse>): void;
        list(params: Params$Resource$Projects$Locations$Extendedmetadataschemas$List, callback: BodyResponseCallback<Schema$ListExtendedMetadataSchemasResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListExtendedMetadataSchemasResponse>): void;
    }
