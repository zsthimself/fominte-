...
export declare namespace apihub_v1 {
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveApiViews(params: Params$Resource$Projects$Locations$Retrieveapiviews, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        retrieveApiViews(params?: Params$Resource$Projects$Locations$Retrieveapiviews, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudApihubV1RetrieveApiViewsResponse>>;
        retrieveApiViews(params: Params$Resource$Projects$Locations$Retrieveapiviews, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        retrieveApiViews(params: Params$Resource$Projects$Locations$Retrieveapiviews, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudApihubV1RetrieveApiViewsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudApihubV1RetrieveApiViewsResponse>): void;
        retrieveApiViews(params: Params$Resource$Projects$Locations$Retrieveapiviews, callback: BodyResponseCallback<Schema$GoogleCloudApihubV1RetrieveApiViewsResponse>): void;
        retrieveApiViews(callback: BodyResponseCallback<Schema$GoogleCloudApihubV1RetrieveApiViewsResponse>): void;
        /**
    ...
    export class Resource$Projects$Locations$Apis$Versions$Specs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchAdditionalSpecContent(params: Params$Resource$Projects$Locations$Apis$Versions$Specs$Fetchadditionalspeccontent, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchAdditionalSpecContent(params?: Params$Resource$Projects$Locations$Apis$Versions$Specs$Fetchadditionalspeccontent, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudApihubV1FetchAdditionalSpecContentResponse>>;
        fetchAdditionalSpecContent(params: Params$Resource$Projects$Locations$Apis$Versions$Specs$Fetchadditionalspeccontent, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetchAdditionalSpecContent(params: Params$Resource$Projects$Locations$Apis$Versions$Specs$Fetchadditionalspeccontent, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudApihubV1FetchAdditionalSpecContentResponse>, callback: BodyResponseCallback<Schema$GoogleCloudApihubV1FetchAdditionalSpecContentResponse>): void;
        fetchAdditionalSpecContent(params: Params$Resource$Projects$Locations$Apis$Versions$Specs$Fetchadditionalspeccontent, callback: BodyResponseCallback<Schema$GoogleCloudApihubV1FetchAdditionalSpecContentResponse>): void;
        fetchAdditionalSpecContent(callback: BodyResponseCallback<Schema$GoogleCloudApihubV1FetchAdditionalSpecContentResponse>): void;
        /**
