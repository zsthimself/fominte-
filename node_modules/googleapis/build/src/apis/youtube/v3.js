...
(function (youtube_v3) {
    ...
    class Resource$Youtube$V3$Videos {
        context;
        constructor(context) {
            this.context = context;
        }
        batchGetStats(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/youtube/v3/videos:batchGetStats').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    youtube_v3.Resource$Youtube$V3$Videos = Resource$Youtube$V3$Videos;
