...
export declare namespace cloudfunctions_v2beta {
    ...
    export class Resource$Projects$Locations$Functions {
         ...
         *   // Do the magic
         *   const res =
         *     await cloudfunctions.projects.locations.functions.commitFunctionUpgradeAsGen2(
         *       {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        commitFunctionUpgradeAsGen2(params: Params$Resource$Projects$Locations$Functions$Commitfunctionupgradeasgen2, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        commitFunctionUpgradeAsGen2(params?: Params$Resource$Projects$Locations$Functions$Commitfunctionupgradeasgen2, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        commitFunctionUpgradeAsGen2(params: Params$Resource$Projects$Locations$Functions$Commitfunctionupgradeasgen2, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        commitFunctionUpgradeAsGen2(params: Params$Resource$Projects$Locations$Functions$Commitfunctionupgradeasgen2, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        commitFunctionUpgradeAsGen2(params: Params$Resource$Projects$Locations$Functions$Commitfunctionupgradeasgen2, callback: BodyResponseCallback<Schema$Operation>): void;
        commitFunctionUpgradeAsGen2(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Functions$Commitfunctionupgradeasgen2 extends StandardParameters {
        /**
         * Required. The name of the function for which upgrade should be committed to Gen2.
         */
        name?: string;
         ...
         * Request body metadata
         */
        requestBody?: Schema$CommitFunctionUpgradeAsGen2Request;
    }
