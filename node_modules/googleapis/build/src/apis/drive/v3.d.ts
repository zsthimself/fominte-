...
export declare namespace drive_v3 {
    ...
    export class Resource$Approvals {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Approvals$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Approvals$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Approval>>;
        get(params: Params$Resource$Approvals$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Approvals$Get, options: MethodOptions | BodyResponseCallback<Schema$Approval>, callback: BodyResponseCallback<Schema$Approval>): void;
        get(params: Params$Resource$Approvals$Get, callback: BodyResponseCallback<Schema$Approval>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Approvals$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Approvals$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ApprovalList>>;
        list(params: Params$Resource$Approvals$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Approvals$List, options: MethodOptions | BodyResponseCallback<Schema$ApprovalList>, callback: BodyResponseCallback<Schema$ApprovalList>): void;
        list(params: Params$Resource$Approvals$List, callback: BodyResponseCallback<Schema$ApprovalList>): void;
